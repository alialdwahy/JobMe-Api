...
const errorMessages = {
    ...
    POST_DATA_INVALID: "job data must be in json format and adhere to the spec",
    POST_ID_INVALID: "job id must be UUID v4",
    POST_NOT_FOUND: "The job requested not found",
};
